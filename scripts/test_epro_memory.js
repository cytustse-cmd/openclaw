...
const { EproMemory } = require('@tobybridges/epro-memory');

const config = {
  embedding: {
    apiKey: 'dummy', // Will be overridden by baseUrl
    baseUrl: 'http://localhost:11434/v1',
    model: 'nomic-embed-text'
  },
  llm: {
    apiKey: process.env.MINIMAX_API_KEY || 'sk-cp-coxAC_y7xyXkO84sJvokXDIIUDlLkXvWVBGWgk0myKnxCC-I7fiQFx-zSkjetcEwIBrGQkPkO_SmTAymeoABQFVN7sDfNjGhCI96pS-4dL0Hadx7O8Z5d9c',
